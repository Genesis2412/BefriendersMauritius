    ...
    <div style="padding-bottom:25px;"> </div>
        <footer class="footer" style="background-color: rgb(99, 165, 99);">
            <div class="footer-left">
                ...
                <p>We an help prevent suicide. Befrienders provide 7/7 9hr to 21hr free and confidential support for people in distress, prevention and crisis resources for you or your loved ones.</p>
            </div>
