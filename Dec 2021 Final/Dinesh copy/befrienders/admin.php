...
<head>
    ...
    <title>Welcome| User <?php  /* $_SESSION['Username']="JEY"; */ if(isset($_SESSION['Username'])){ echo $_SESSION["Username"]; } else { echo "Stranger"; } ?> to Admin Panel</title>
  ...
  <header style="right:-100px;" class="page-header">            <!-- remove disp none    style="display:none;"   -->
    <nav>
      ...
      <ul class="admin-menu">
        ...
        <li>
        <a  id="changePwd" href='#changepassContainer'>
        <svg>
