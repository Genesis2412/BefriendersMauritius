...
echo "<button style='background-color:grey;color:white;padding:10px;border-radius:5px;'> <a target='_blank' href='./#chatbotToggle' style='color:white;'> Go to chatbot </a> </button> &nbsp;";
...
if(mysqli_num_rows($result)>0){
    ...
    while($row=mysqli_fetch_assoc($result)){
        ...
        echo "<th style='padding:5px;'> ".$row['reply']." </th>";
         ...
         echo "<td style='padding:5px;'> <button style='background-color:red;color:white;padding:10px;border-radius:5px;'> <a style='color:white;' href='deleteEntry.php?delID=".$row['recordID']."'> Delete </a> </button> </td>";
